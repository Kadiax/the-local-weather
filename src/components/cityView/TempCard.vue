    ...
    <div class="data">
      <div class="weather">
        ...
        <div class="temperature">
          ...
          <div class="high-low">
            High: {{ roundedTemperature(weatherData?.main?.temp_max) }}&deg;
            Low: {{ roundedTemperature(weatherData?.main?.temp_min) }}&deg;
          </div>
        </div>
      </div>
      <div class="icon">
        ...
        <div class="description">
          ...
          <div class="feels-like">
            Feels Like {{ roundedTemperature(weatherData?.main?.feels_like) }}
          </div>
        </div>
      </div>
    </div>
...
const formattedDescription = computed(() => {
  return props.weatherData?.weather?.[0]?.description
    ? capitalize(props.weatherData.weather[0].description)
    : "--";
});
</script>
